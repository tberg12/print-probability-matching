...
if __name__ == '__main__':
    raw_dir = "/home/kishore/projects/print-probability/anomaly-detection/test-notebooks/skeletonize/Morpho-MNIST/mnist"
    dataset_root = os.path.join(raw_dir, 'mnist_perturbed')

...
for query_set in "manualspinoza_fnames.csv" "manuallocke_fnames.csv" "manualfortysermons_fnames.csv" "manualcriticalenquiries_fnames.csv"; do
        ...
        for candidate_set in "braddyll_voyageofitaly.txt"; do

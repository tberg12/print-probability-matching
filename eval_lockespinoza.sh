...
# BEFHKMNPQRW
for char in B E F H K M N P Q R W; do  #C L P; do
    ckpt=$(find /trunk/nvog/matching_results_aaai2022_SunAug14/ -type f -path "*Char${char}*TempResidual_ModelAttention_5000TrainPairs_GlobalInkTrue_2CNNBlocks_3ConvPerBlock_EmbSz128_hw_sum_Temp1.0_Jitter_Margin0.3_Bsz64_AdamLR0.0001*best.pt"  -exec stat --format='%W %n' {} + | sort -n | awk '{print $2}' | tail -1)
    ...
    CUDA_VISIBLE_DEVICES=$d python3 matcher.py \
            ...
            --evaluate_ckpt \
            --evaluate_ckpt_dest /trunk/nvog/matching_results_lockespinoza \
            --load_model $ckpt \
            # --load_model "/trunk/nvog/matching_results_aaai2022_SunAug14/Char${char}_TempResidual_ModelAttention_5000TrainPairs_GlobalInkTrue_2CNNBlocks_3ConvPerBlock_EmbSz128_hw_sum_Temp1.0_Jitter_Margin0.3_Bsz64_AdamLR0.0001-2022-08-14_21:10:24/epoch60.pt"
            #--wandb &

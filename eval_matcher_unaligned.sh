...
# char="A B C"
char="A B C D E F G H K L M N P R T W"
# char="N"
# char="N"
# char="A B C F G H N O P Q R T"  # NOTE: for chars in gt_test_lockespinoza_mix_neg
# NOTE: No synthetic data directory for character O in data/synthetic_data
# char="A B C F G H N P Q R T"  # NOTE: for chars in gt_test_lockespinoza_mix_neg
...
limit_train_pairs=1500
evalfreq=1
margin=0.3
metric="gt_test_mix_neg"  # syn_valid

limit_eval_keys="gt_test_mix_neg"
# limit_eval_keys="gt_test_lockespinoza_mix_neg"

limit_eval_size=1000

# encoder_type="hf_hub:timm/vit_base_patch16_224.augreg2_in21k_ft_in1k"
# model_type="CrossEncoder"
# ckpt="CharABCDEFGHKLMNPRSTW_ModelCrossEncoder_EncoderVit_base_patch16_224.augreg2_in21k_ft_in1k_15000TrainPairs_LimitEval50_GlobalInkTrue_Pretrained_Temp1.0_Augment_TripletBCE-random_Bsz88_AdamLR0.0001_SchedulerWU500-2024-12-14_13:15:30/best.pt"
encoder_type="hf_hub:timm/vit_base_patch8_224.dino"
model_type="DualEncoder"
ckpt="CharABCDEFGHKLMNPRSTW_ModelDualEncoder_EncoderVit_base_patch8_224.dino_15000TrainPairs_LimitEval50_GlobalInkTrue_Pretrained_Temp1.0_Augment_NPairs_Bsz84_AdamLR0.0001_SchedulerWU500-2024-12-14_13:15:30/best.pt"
...
CUDA_VISIBLE_DEVICES=$d python matcher.py \
        ...
        --evaluate_ckpt \
        --k 1000 \
        --limit_eval_keys ${limit_eval_keys} \
        --apply_damage_score_filter damage_classifier_output/evaluate/${limit_eval_keys}_damagepredictions.csv 0.001
        # NOTE: high k for ability to create histogram of hit positions 

        # --evaluate_ckpt  #&> output/matching_eval_nov24/eval_${ckpt}_d${d}_${date_str}.log

        # --discover_matches queries.txt candidates.txt

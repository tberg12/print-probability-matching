...
python alignment/aligner.py -ink_var 0.2 -data $1 -aligncsv $2"_align.csv" -init_rand -nc 1 -y_pix 64 -gpu $3 -epochs $epochs -optim adam -adj_optim adam -adj_learning_rate "$lr" -visualize -batch_size $batch_size -output $2"_template" -rec $2"_aligned" -save_dir $2"_model" -lbd 0.05 -train_from $4 -freeze_template_params
#-no_binarize
